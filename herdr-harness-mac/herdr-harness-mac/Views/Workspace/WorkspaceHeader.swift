    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            HStack(spacing: 12) {
                ...
                // iOS raised a drawer here; the Mac navigator is the split
                // view's own sidebar column, so this collapses/expands it.
                Button("Toggle navigator", systemImage: "sidebar.leading") {
